...
export const CHATGPT_DOCUMENT_PROMPT = 'Suggest a CampusWireApi to find like the following document.  ' +
    `Provide just the query, no quotes, no other text, and a maximum of ${MAX_SEARCH_TERMS} words:\n\ntitle: "%TITLE%"\nbody:"%BODY%"`;
